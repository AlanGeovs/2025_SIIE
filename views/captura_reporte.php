...
<form id="formReporte" enctype="multipart/form-data" onsubmit="enviarFormulario(event)">
    ...
    <div id="seccion2">
        ...
        <div id="tabla_areas_principales">
            ...
            <div class="mt-4">
                <h4 class="mb-3" style="color: #691C32;">3. Descripción del siniestro</h4>
                <label for="descripcion_siniestro" class="form-label ">Escribe brevemente los hechos en no más de <span class="text-muted">400 caracteres.</span></label>
