...
function muestraArea4(){  
    var idEdificio=document.getElementsByName("idEdificio4")[0].value;
...
var data={
  ...
  $.ajax({
    ...
    <!-- Áreas principales -->
    <div class="table-responsive mb-4" id="equipo">
